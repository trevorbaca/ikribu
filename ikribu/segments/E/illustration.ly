...
\score {
    \context Score = "Score" \with {
        ...
        \context GlobalContext = "GlobalContext" <<
            ...
            %%% \set Score.proportionalNotationDuration = #(ly:make-moment 1 12)         %! -SEGMENT:-ARCH_A_PARTS:SPACING:HSS1
                \noBreak                                                                 %! +SEGMENT:BREAKS:LMM2
            %@% \newSpacingSection                                                       %! -SEGMENT:+ARCH_A_PARTS:SPACING_OVERRIDE:SOC1
            %@% \set Score.proportionalNotationDuration = #(ly:make-moment 35 288)       %! -SEGMENT:+ARCH_A_PARTS:SPACING_OVERRIDE:SOC1
            ...
            %@%     }                                                                    %! EXPLICIT_METRONOME_MARK:SM27 %! SM29
                ...
                ^ \markup {
                    \column
                        ...
                        %@%                 [1/12]                                       %! -SEGMENT:-ARCH_A_PARTS:SPACING_MARKUP:HSS2
                        %@%     }                                                        %! -SEGMENT:-ARCH_A_PARTS:SPACING_MARKUP:HSS2
                        %@% \line                                                        %! CLOCK_TIME_MARKUP:SM28
                        %@%     {                                                        %! CLOCK_TIME_MARKUP:SM28
                        %@%         \with-color                                          %! CLOCK_TIME_MARKUP:SM28
                        ...
                        %@%                 [[35/288]]                                   %! -SEGMENT:+ARCH_A_PARTS:SPACING_OVERRIDE_MARKUP:SOC2
                        %@%     }                                                        %! -SEGMENT:+ARCH_A_PARTS:SPACING_OVERRIDE_MARKUP:SOC2
