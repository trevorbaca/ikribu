...
\score {
    \context Score = "Score" \with {
        ...
        \context GlobalContext = "GlobalContext" <<
            ...
            %%% \set Score.proportionalNotationDuration = #(ly:make-moment 1 12)         %! -SEGMENT:-ARCH_A_SCORE:-ARCH_A_11_SCORE:SPACING:HSS1
            %@% \newSpacingSection                                                       %! -SEGMENT:-ARCH_A_SCORE:+ARCH_A_11_SCORE:SPACING_OVERRIDE:SOC1
            %@% \set Score.proportionalNotationDuration = #(ly:make-moment 1 8)          %! -SEGMENT:-ARCH_A_SCORE:+ARCH_A_11_SCORE:SPACING_OVERRIDE:SOC1
            %@% \newSpacingSection                                                       %! -SEGMENT:+ARCH_A_SCORE:SPACING_OVERRIDE:SOC1
            %@% \set Score.proportionalNotationDuration = #(ly:make-moment 1 4)          %! -SEGMENT:+ARCH_A_SCORE:SPACING_OVERRIDE:SOC1
                \noBreak                                                                 %! +SEGMENT:LAYOUT:LMM2
                \newSpacingSection                                                       %! +SEGMENT:SPACING_OVERRIDE:SOC1 %@%
                \set Score.proportionalNotationDuration = #(ly:make-moment 35 288)       %! +SEGMENT:SPACING_OVERRIDE:SOC1 %@%
                \time 8/4                                                                %! EXPLICIT_TIME_SIGNATURE:SM8
                ...
                ^ \markup {
                    \column
                        ...
                        %@%                 [1/12]                                       %! -SEGMENT:-ARCH_A_SCORE:-ARCH_A_11_SCORE:SPACING_MARKUP:HSS2
                        %@%     }                                                        %! -SEGMENT:-ARCH_A_SCORE:-ARCH_A_11_SCORE:SPACING_MARKUP:HSS2
                        ...
                        %@%             #(x11-color 'DeepPink1)                          %! -SEGMENT:-ARCH_A_SCORE:+ARCH_A_11_SCORE:SPACING_OVERRIDE_MARKUP:SOC2
                        ...
                        %@%                 [1/8]                                        %! -SEGMENT:-ARCH_A_SCORE:+ARCH_A_11_SCORE:SPACING_OVERRIDE_MARKUP:SOC2
                        %@%     }                                                        %! -SEGMENT:-ARCH_A_SCORE:+ARCH_A_11_SCORE:SPACING_OVERRIDE_MARKUP:SOC2
                        ...
                        %@%                 [1/4]                                        %! -SEGMENT:+ARCH_A_SCORE:SPACING_OVERRIDE_MARKUP:SOC2
                        %@%     }                                                        %! -SEGMENT:+ARCH_A_SCORE:SPACING_OVERRIDE_MARKUP:SOC2
                        %@% \line                                                        %! CLOCK_TIME_MARKUP:SM28
                        %@%     {                                                        %! CLOCK_TIME_MARKUP:SM28
                        %@%         \with-color                                          %! CLOCK_TIME_MARKUP:SM28
