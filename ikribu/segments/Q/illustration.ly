...
\score {
    \context Score = "Score" \with {
        ...
        \context GlobalContext = "GlobalContext" <<
            ...
            %F%             =                                                            %! EXPLICIT_METRONOME_MARK:SM27                %! SM29
            %F%             66                                                           %! EXPLICIT_METRONOME_MARK:SM27                %! SM29
            %F%         }                                                                %! EXPLICIT_METRONOME_MARK:SM27                %! SM29
            %F%     }                                                                    %! EXPLICIT_METRONOME_MARK:SM27                %! SM29
                    ...
                    \with-color                                                          %! EXPLICIT_METRONOME_MARK_WITH_COLOR:SM15 %! SM29
                        ...
                        {                                                                %! EXPLICIT_METRONOME_MARK_WITH_COLOR:SM15 %! SM29
                            ...
                            \upright                                                     %! EXPLICIT_METRONOME_MARK_WITH_COLOR:SM15 %! SM29
                                {                                                        %! EXPLICIT_METRONOME_MARK_WITH_COLOR:SM15 %! SM29
                                    =                                                    %! EXPLICIT_METRONOME_MARK_WITH_COLOR:SM15 %! SM29
                                    66                                                   %! EXPLICIT_METRONOME_MARK_WITH_COLOR:SM15 %! SM29
                                }                                                        %! EXPLICIT_METRONOME_MARK_WITH_COLOR:SM15 %! SM29
                        }                                                                %! EXPLICIT_METRONOME_MARK_WITH_COLOR:SM15 %! SM29
                    }                                                                    %! EXPLICIT_METRONOME_MARK_WITH_COLOR:SM15 %! SM29
                ...
                \once \override Score.TimeSignature.color = #(x11-color 'blue)           %! EXPLICIT_TIME_SIGNATURE_COLOR:SM6
                \newSpacingSection                                                       %! SEGMENT:SPACING:HSS1
                \set Score.proportionalNotationDuration = #(ly:make-moment 1 18)         %! SEGMENT:SPACING:HSS1
                s1 * 2
                ^ \markup {
                    \column
                        {
                        ...
                        %%%             \fontsize                                        %! SEGMENT:SPACING_MARKUP:HSS2
                        %%%                 #-3                                          %! SEGMENT:SPACING_MARKUP:HSS2
                        %%%                 (1/18)                                       %! SEGMENT:SPACING_MARKUP:HSS2
                        %%%     }                                                        %! SEGMENT:SPACING_MARKUP:HSS2
                        }
                    }
                ...
                \once \override Score.TimeSignature.color = #(x11-color 'blue)           %! EXPLICIT_TIME_SIGNATURE_COLOR:SM6
                \newSpacingSection                                                       %! SEGMENT:SPACING:HSS1
                \set Score.proportionalNotationDuration = #(ly:make-moment 7 128)        %! SEGMENT:SPACING:HSS1
                s1 * 7/4
                ^ \markup {
                    \column
                        {
                        ...
                        %%%             \fontsize                                        %! SEGMENT:SPACING_MARKUP:HSS2
                        %%%                 #-3                                          %! SEGMENT:SPACING_MARKUP:HSS2
                        %%%                 (7/128)                                      %! SEGMENT:SPACING_MARKUP:HSS2
                        %%%     }                                                        %! SEGMENT:SPACING_MARKUP:HSS2
                        }
                    }
