...
\score {
    \context Score = "Score" \with {
        ...
        \context GlobalContext = "GlobalContext" <<
            ...
            %F% \set Score.proportionalNotationDuration = #(ly:make-moment 35 720)       %! +LEDGER_SCORE:SPACING_OVERRIDE:SOC1
                \noBreak                                                                 %! +SEGMENT:LAYOUT:LMM2
            ...
            %%% \once \override Score.TimeSignature.color = #(x11-color 'blue)           %! EXPLICIT_TIME_SIGNATURE_COLOR:SM6
                ...
                ^ \markup {
                    \column
                        ...
                        %F%                     (35/720)                                 %! +LEDGER_SCORE:SPACING_OVERRIDE_MARKUP:SOC2
                        %F%     }                                                        %! +LEDGER_SCORE:SPACING_OVERRIDE_MARKUP:SOC2
                        %%% \line                                                        %! CLOCK_TIME_MARKUP:SM28
                        %%%     {                                                        %! CLOCK_TIME_MARKUP:SM28
                        %%%         \fontsize                                            %! CLOCK_TIME_MARKUP:SM28
            ...
            %%% \once \override Score.TimeSignature.color = #(x11-color 'blue)           %! EXPLICIT_TIME_SIGNATURE_COLOR:SM6
                ...
                \set Score.proportionalNotationDuration = #(ly:make-moment 35 720)       %! +SEGMENT:SPACING_OVERRIDE:SOC1 %F%
                \noBreak                                                                 %! +SEGMENT:LAYOUT:LMM2
                                    ...
                                    \with-color                                          %! +SEGMENT:SPACING_OVERRIDE_MARKUP:SOC2 %F%
                                        ...
                                        \bold                                            %! +SEGMENT:SPACING_OVERRIDE_MARKUP:SOC2 %F%
                                            \fontsize                                    %! +SEGMENT:SPACING_OVERRIDE_MARKUP:SOC2 %F%
                                                ...
                                                (35/720)                                 %! +SEGMENT:SPACING_OVERRIDE_MARKUP:SOC2 %F%
                                }                                                        %! +SEGMENT:SPACING_OVERRIDE_MARKUP:SOC2 %F%
                        %%% \line                                                        %! CLOCK_TIME_MARKUP:SM28
                        %%%     {                                                        %! CLOCK_TIME_MARKUP:SM28
                        %%%         \fontsize                                            %! CLOCK_TIME_MARKUP:SM28
