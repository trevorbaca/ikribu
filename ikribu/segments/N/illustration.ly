                    ...
                    \context ViolaMusicStaff = "ViolaMusicStaff" {
                        \context ViolaMusicVoice = "ViolaMusicVoice" {
                            \times 2/3 {
                                ...
                                \once \override Staff.StaffSymbol.line-count = 5
                                \startStaff
                                \clef "treble" % SEGMENT:DUPLICATE_CLEF:2
                                \override Staff.Clef.color = #(x11-color 'DeepPink1) % SEGMENT:DUPLICATE_CLEF:1
                                \set Staff.forceClef = ##t % SEGMENT:DUPLICATE_CLEF:3
