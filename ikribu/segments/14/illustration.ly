        ...
        <<                                                                     %! ikribu.ScoreTemplate.__call__()
            ...
            {                                                                  %! ikribu.ScoreTemplate.__call__()
                ...
                <<                                                             %! ikribu.ScoreTemplate.__call__()
                    ...
                    \n_Bass_Clarinet_Music_Staff                               %! ide.Path.extern()
                    ...
                    <<                                                         %! ikribu.ScoreTemplate.__call__()
                        ...
                        \n_Violin_RH_Music_Staff                               %! ide.Path.extern()

                        \context Staff = "Violin_Music_Staff"                  %! ikribu.ScoreTemplate.__call__()
                        \n_Violin_Music_Staff                                  %! ide.Path.extern()
                    ...
                    <<                                                         %! ikribu.ScoreTemplate.__call__()
                        ...
                        \n_Viola_RH_Music_Staff                                %! ide.Path.extern()
                    ...
                    <<                                                         %! ikribu.ScoreTemplate.__call__()
                        ...
                        \n_Cello_RH_Music_Staff                                %! ide.Path.extern()
