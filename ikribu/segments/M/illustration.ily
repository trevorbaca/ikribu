...
%@% ^ \markup \baca-dark-cyan-markup "[13'16'']"                                                   %! CLOCK_TIME_MARKUP:_label_clock_time
...
%@% ^ \markup \baca-dark-cyan-markup "[13'41'']"                                                   %! CLOCK_TIME_MARKUP:_label_clock_time
...
%@% ^ \markup \baca-dark-cyan-markup "[13'44'']"                                                   %! CLOCK_TIME_MARKUP:_label_clock_time
...
%@% ^ \markup \baca-dark-cyan-markup "[13'56'']"                                                   %! CLOCK_TIME_MARKUP:_label_clock_time
...
%@% ^ \markup \baca-dark-cyan-markup "[14'00'']"                                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    \stopTextSpan                                                                                  %! _attach_metronome_marks(1)
%@% - \abjad_invisible_line                                                                        %! _attach_metronome_marks(2)
%@% - \tweak bound-details.left.text \markup {                                                     %! _attach_metronome_marks(2)
%@%     \concat                                                                                    %! _attach_metronome_marks(2)
...
%@% ^ \markup \baca-dark-cyan-markup "[14'09'']"                                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    \stopTextSpan                                                                                  %! _attach_metronome_marks(1)
%@% - \abjad_dashed_line_with_arrow                                                                %! _attach_metronome_marks(2)
%@% - \tweak bound-details.left.text \markup {                                                     %! _attach_metronome_marks(2)
%@%     \concat                                                                                    %! _attach_metronome_marks(2)
...
%@% ^ \markup \baca-dark-cyan-markup "[14'19'']"                                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    \stopTextSpan                                                                                  %! _attach_metronome_marks(1)
%@% - \abjad_dashed_line_with_arrow                                                                %! _attach_metronome_marks(2)
%@% - \tweak bound-details.left.text \markup {                                                     %! _attach_metronome_marks(2)
%@%     \concat                                                                                    %! _attach_metronome_marks(2)
...
%@% ^ \markup \baca-dark-cyan-markup "[14'24'']"                                                   %! CLOCK_TIME_MARKUP:_label_clock_time
...
%@% ^ \markup \baca-dark-cyan-markup "[14'33'']"                                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    \stopTextSpan                                                                                  %! _attach_metronome_marks(1)
%@% - \abjad_invisible_line                                                                        %! _attach_metronome_marks(2)
%@% - \tweak bound-details.left.text \markup {                                                     %! _attach_metronome_marks(2)
%@%     \concat                                                                                    %! _attach_metronome_marks(2)
...
%@% ^ \markup \baca-dark-cyan-markup [M.30]                                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
...
%@% ^ \markup \baca-dark-cyan-markup [M.31]                                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[14'55'']"                                                   %! CLOCK_TIME_MARKUP:_label_clock_time
...
%@% ^ \markup \baca-dark-cyan-markup [M.32]                                                        %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[14'59'']"                                                   %! CLOCK_TIME_MARKUP:_label_clock_time
