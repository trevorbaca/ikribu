...
maker(
    ('bcl', [(2, 3), (9, 10), (13, 14)]),
    baca.new_hairpin('p < fff', selector=baca.leaves()[:2]),
    baca.new_hairpin('fff >o niente', selector=baca.rleaves()[-2:]),
    )

maker(
    ('bcl', (20, 22)),
    baca.new_hairpin('ppp < fff', selector=baca.leaves()[:-1]),
    )
