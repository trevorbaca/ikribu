    ...
    \context Score = "Score" \with {
        ...
        \context GlobalContext = "GlobalContext" <<
            ...
            %@%     }                                                                    %! REAPPLIED_METRONOME_MARK:SM27 %! SM29
                ...
                \newSpacingSection                                                       %! -LEDGER_SCORE:-ARCH_A_SCORE:-ARCH_A_PARTS:SPACING:HSS1
                \set Score.proportionalNotationDuration = #(ly:make-moment 1 4)          %! -LEDGER_SCORE:-ARCH_A_SCORE:-ARCH_A_PARTS:SPACING:HSS1
                \noBreak                                                                 %! +SEGMENT:LAYOUT:LMM2
            %@% \newSpacingSection                                                       %! -LEDGER_SCORE:-ARCH_A_SCORE:+ARCH_A_PARTS:SPACING_OVERRIDE:SOC1
            %@% \set Score.proportionalNotationDuration = #(ly:make-moment 35 96)        %! -LEDGER_SCORE:-ARCH_A_SCORE:+ARCH_A_PARTS:SPACING_OVERRIDE:SOC1
            %@% \newSpacingSection                                                       %! -LEDGER_SCORE:+ARCH_A_SCORE:SPACING_OVERRIDE:SOC1
            %@% \set Score.proportionalNotationDuration = #(ly:make-moment 35 96)        %! -LEDGER_SCORE:+ARCH_A_SCORE:SPACING_OVERRIDE:SOC1
            ...
            %@% \set Score.proportionalNotationDuration = #(ly:make-moment 35 96)        %! +LEDGER_SCORE:SPACING_OVERRIDE:SOC1
                ...
                ^ \markup {
                    \column
                        ...
                        %@%     }                                                        %! STAGE_NUMBER_MARKUP:SM3
                        %@% \line                                                        %! -LEDGER_SCORE:-ARCH_A_SCORE:-ARCH_A_PARTS:SPACING_MARKUP:HSS2
                        %@%     {                                                        %! -LEDGER_SCORE:-ARCH_A_SCORE:-ARCH_A_PARTS:SPACING_MARKUP:HSS2
                        %@%         \with-color                                          %! -LEDGER_SCORE:-ARCH_A_SCORE:-ARCH_A_PARTS:SPACING_MARKUP:HSS2
                        %@%             #(x11-color 'DarkCyan)                           %! -LEDGER_SCORE:-ARCH_A_SCORE:-ARCH_A_PARTS:SPACING_MARKUP:HSS2
                        %@%             \fontsize                                        %! -LEDGER_SCORE:-ARCH_A_SCORE:-ARCH_A_PARTS:SPACING_MARKUP:HSS2
                        %@%                 #3                                           %! -LEDGER_SCORE:-ARCH_A_SCORE:-ARCH_A_PARTS:SPACING_MARKUP:HSS2
                        %@%                 [1/4]                                        %! -LEDGER_SCORE:-ARCH_A_SCORE:-ARCH_A_PARTS:SPACING_MARKUP:HSS2
                        %@%     }                                                        %! -LEDGER_SCORE:-ARCH_A_SCORE:-ARCH_A_PARTS:SPACING_MARKUP:HSS2
                        %@% \line                                                        %! CLOCK_TIME_MARKUP:SM28
                        %@%     {                                                        %! CLOCK_TIME_MARKUP:SM28
                        %@%         \with-color                                          %! CLOCK_TIME_MARKUP:SM28
                        ...
                        %@%     }                                                        %! CLOCK_TIME_MARKUP:SM28
                        %@% \line                                                        %! -LEDGER_SCORE:-ARCH_A_SCORE:+ARCH_A_PARTS:SPACING_OVERRIDE_MARKUP:SOC2
                        %@%     {                                                        %! -LEDGER_SCORE:-ARCH_A_SCORE:+ARCH_A_PARTS:SPACING_OVERRIDE_MARKUP:SOC2
                        %@%         \with-color                                          %! -LEDGER_SCORE:-ARCH_A_SCORE:+ARCH_A_PARTS:SPACING_OVERRIDE_MARKUP:SOC2
                        %@%             #(x11-color 'DarkOrange)                         %! -LEDGER_SCORE:-ARCH_A_SCORE:+ARCH_A_PARTS:SPACING_OVERRIDE_MARKUP:SOC2
                        %@%             \fontsize                                        %! -LEDGER_SCORE:-ARCH_A_SCORE:+ARCH_A_PARTS:SPACING_OVERRIDE_MARKUP:SOC2
                        %@%                 #3                                           %! -LEDGER_SCORE:-ARCH_A_SCORE:+ARCH_A_PARTS:SPACING_OVERRIDE_MARKUP:SOC2
                        %@%                 [[35/96]]                                    %! -LEDGER_SCORE:-ARCH_A_SCORE:+ARCH_A_PARTS:SPACING_OVERRIDE_MARKUP:SOC2
                        %@%     }                                                        %! -LEDGER_SCORE:-ARCH_A_SCORE:+ARCH_A_PARTS:SPACING_OVERRIDE_MARKUP:SOC2
                        ...
                        %@%                 [[35/96]]                                    %! -LEDGER_SCORE:+ARCH_A_SCORE:SPACING_OVERRIDE_MARKUP:SOC2
                        %@%     }                                                        %! -LEDGER_SCORE:+ARCH_A_SCORE:SPACING_OVERRIDE_MARKUP:SOC2
            ...
            %@% \set Score.proportionalNotationDuration = #(ly:make-moment 35 96)        %! +ARCH_A_SCORE:SPACING_OVERRIDE:SOC1
                ...
                \newSpacingSection                                                       %! -LEDGER_SCORE:-ARCH_A_PARTS:SPACING:HSS1
                \set Score.proportionalNotationDuration = #(ly:make-moment 1 12)         %! -LEDGER_SCORE:-ARCH_A_PARTS:SPACING:HSS1
                \noBreak                                                                 %! +SEGMENT:LAYOUT:LMM2
            %@% \newSpacingSection                                                       %! -LEDGER_SCORE:+ARCH_A_PARTS:SPACING_OVERRIDE:SOC1
            %@% \set Score.proportionalNotationDuration = #(ly:make-moment 35 288)       %! -LEDGER_SCORE:+ARCH_A_PARTS:SPACING_OVERRIDE:SOC1
            %@% \newSpacingSection                                                       %! +LEDGER_SCORE:SPACING_OVERRIDE:SOC1
            %@% \set Score.proportionalNotationDuration = #(ly:make-moment 35 288)       %! +LEDGER_SCORE:SPACING_OVERRIDE:SOC1
                ...
                ^ \markup {
                    \column
                        ...
                        %@%     }                                                        %! MEASURE_NUMBER_MARKUP:SM31
                        %@% \line                                                        %! -LEDGER_SCORE:-ARCH_A_PARTS:SPACING_MARKUP:HSS2
                        %@%     {                                                        %! -LEDGER_SCORE:-ARCH_A_PARTS:SPACING_MARKUP:HSS2
                        %@%         \with-color                                          %! -LEDGER_SCORE:-ARCH_A_PARTS:SPACING_MARKUP:HSS2
                        %@%             #(x11-color 'DarkCyan)                           %! -LEDGER_SCORE:-ARCH_A_PARTS:SPACING_MARKUP:HSS2
                        %@%             \fontsize                                        %! -LEDGER_SCORE:-ARCH_A_PARTS:SPACING_MARKUP:HSS2
                        %@%                 #3                                           %! -LEDGER_SCORE:-ARCH_A_PARTS:SPACING_MARKUP:HSS2
                        %@%                 [1/12]                                       %! -LEDGER_SCORE:-ARCH_A_PARTS:SPACING_MARKUP:HSS2
                        %@%     }                                                        %! -LEDGER_SCORE:-ARCH_A_PARTS:SPACING_MARKUP:HSS2
                        %@% \line                                                        %! CLOCK_TIME_MARKUP:SM28
                        %@%     {                                                        %! CLOCK_TIME_MARKUP:SM28
                        %@%         \with-color                                          %! CLOCK_TIME_MARKUP:SM28
                        ...
                        %@%                 [[35/288]]                                   %! -LEDGER_SCORE:+ARCH_A_PARTS:SPACING_OVERRIDE_MARKUP:SOC2
                        %@%     }                                                        %! -LEDGER_SCORE:+ARCH_A_PARTS:SPACING_OVERRIDE_MARKUP:SOC2
                        %@% \line                                                        %! +LEDGER_SCORE:SPACING_OVERRIDE_MARKUP:SOC2
                        %@%     {                                                        %! +LEDGER_SCORE:SPACING_OVERRIDE_MARKUP:SOC2
                        %@%         \with-color                                          %! +LEDGER_SCORE:SPACING_OVERRIDE_MARKUP:SOC2
            ...
            %%% \newSpacingSection                                                       %! -SEGMENT:-ARCH_A_SCORE:SPACING:HSS1
            %%% \set Score.proportionalNotationDuration = #(ly:make-moment 1 4)          %! -SEGMENT:-ARCH_A_SCORE:SPACING:HSS1
                \noBreak                                                                 %! +SEGMENT:LAYOUT:LMM2
            ...
            %@% \set Score.proportionalNotationDuration = #(ly:make-moment 35 96)        %! -SEGMENT:+ARCH_A_SCORE:SPACING_OVERRIDE:SOC1
                ...
                ^ \markup {
                    \column
                        ...
                        %@%     }                                                        %! STAGE_NUMBER_MARKUP:SM3
                        %@% \line                                                        %! -SEGMENT:-ARCH_A_SCORE:SPACING_MARKUP:HSS2
                        %@%     {                                                        %! -SEGMENT:-ARCH_A_SCORE:SPACING_MARKUP:HSS2
                        %@%         \with-color                                          %! -SEGMENT:-ARCH_A_SCORE:SPACING_MARKUP:HSS2
                        %@%             #(x11-color 'DarkCyan)                           %! -SEGMENT:-ARCH_A_SCORE:SPACING_MARKUP:HSS2
                        %@%             \fontsize                                        %! -SEGMENT:-ARCH_A_SCORE:SPACING_MARKUP:HSS2
                        %@%                 #3                                           %! -SEGMENT:-ARCH_A_SCORE:SPACING_MARKUP:HSS2
                        %@%                 [1/4]                                        %! -SEGMENT:-ARCH_A_SCORE:SPACING_MARKUP:HSS2
                        %@%     }                                                        %! -SEGMENT:-ARCH_A_SCORE:SPACING_MARKUP:HSS2
                        %@% \line                                                        %! CLOCK_TIME_MARKUP:SM28
                        %@%     {                                                        %! CLOCK_TIME_MARKUP:SM28
                        %@%         \with-color                                          %! CLOCK_TIME_MARKUP:SM28
                ...
                \context ViolaStaffGroup = "ViolaStaffGroup" <<
                    ...
                    \context ViolaMusicStaff = "ViolaMusicStaff" {
                        \context ViolaMusicVoice = "ViolaMusicVoice" {
                            ...
                            \override TextScript.staff-padding = #3                      %! OC
                            \override TextSpanner.staff-padding = #3.5                   %! OC
                        %@% \once \override ViolaMusicStaff.Clef.X-extent = ##f          %! +ARCH_A_PARTS:OC
                        %@% \once \override ViolaMusicStaff.Clef.extra-offset = #'(-2.75 . 0) %! +ARCH_A_PARTS:OC
