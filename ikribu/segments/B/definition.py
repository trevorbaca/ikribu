...
maker(
    ('bcl', 13),
    baca.new_hairpin('ppp < f', selector=baca.leaves()[:2]),
...
maker(
    ('vn', [1, 5, 9]),
    baca.suite(
        baca.new_hairpin('ppp < p', selector=baca.leaves()[:2]),
        baca.new_hairpin('p >o niente', selector=baca.rleaves()[-2:]),
        ),
    baca.transition(
...
maker(
    ('va', (13, 14)),
    baca.suite(
        baca.new_hairpin('ppp < mf', selector=baca.leaves()[:5]),
        baca.new_hairpin('mf >o niente', selector=baca.rleaves()[-2:]),
        ),
    baca.transition(
        baca.markups.markup('trem. flaut. pont.'),
        baca.markups.markup('trem. flaut. tast.'),
