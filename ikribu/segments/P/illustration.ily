...
P_CelloMusicVoice = {
    ...
    \times 1/1 {
        ...
        \startStaff                                          %! SM8:REAPPLIED_STAFF_LINES:SM37
    %%% \once \override CelloMusicStaff.Clef.X-extent = ##f  %! OC1:MEASURE_239:SHIFTED_CLEF
    %%% \once \override CelloMusicStaff.Clef.extra-offset = #'(-2.75 . 0) %! OC1:MEASURE_239:SHIFTED_CLEF
