    ...
    \context Score = "Score" \with {
        ...
        \context GlobalContext = "GlobalContext" <<
            ...
            \context GlobalSkips = "GlobalSkips" {
                ...
                #'((Y-offset . 20) (alignment-distances . (15 15 20 22.5)))              %! BREAKS:BMM3
            ...
            %@% \set Score.proportionalNotationDuration = #(ly:make-moment 35 384)       %! -SEGMENT:+ARCH_A_PARTS_BCL:SPACING_OVERRIDE:SOC1
                ...
                \noBreak                                                                 %! BREAKS:BMM2
                \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details  %! BREAKS:BMM3
                #'((Y-offset . 140) (alignment-distances . (15 15 20 22.5)))             %! BREAKS:BMM3
                \time 4/4                                                                %! EXPLICIT_TIME_SIGNATURE:SM8
                \once \override Score.TimeSignature.color = #(x11-color 'blue)           %! EXPLICIT_TIME_SIGNATURE_COLOR:SM6
                \break                                                                   %! BREAKS:BMM3
                s1 * 1
            ...
            %%% \set Score.proportionalNotationDuration = #(ly:make-moment 1 16)         %! -SEGMENT:SPACING:HSS1
                ...
                \noBreak                                                                 %! BREAKS:BMM2
                \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details  %! BREAKS:BMM3
                #'((Y-offset . 140) (alignment-distances . (15 15 20 20)))               %! BREAKS:BMM3
            %@% \newSpacingSection                                                       %! +ARCH_A_SCORE:SPACING_OVERRIDE:SOC1
            %@% \set Score.proportionalNotationDuration = #(ly:make-moment 35 384)       %! +ARCH_A_SCORE:SPACING_OVERRIDE:SOC1
                \once \override Score.TimeSignature.color = #(x11-color 'DeepPink1)      %! REDUNDANT_TIME_SIGNATURE_COLOR:SM6
                \break                                                                   %! BREAKS:BMM3
