...
L_Violin_Music_Voice = {                                                       %! abjad.Path.extern
    ...
    \once \override DynamicText.extra-offset = #'(-3.5 . 0)                    %! baca.dynamic_text_extra_offset():baca.hairpin_start_shift():OverrideCommand(1)
    \once \override DynamicText.X-extent = #'(0 . 0)                           %! baca.dynamic_text_x_extent_zero():baca.hairpin_start_shift():OverrideCommand(1)
    \override Hairpin.shorten-pair = #'(2.25 . 0)                              %! baca.hairpin_shorten_pair():baca.hairpin_start_shift():OverrideCommand(1)
    c'8                                                                        %! ikribu.clb_rhythm
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
