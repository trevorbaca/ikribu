...
%%% \once \override BassClarinetMusicStaff.Clef.X-extent = ##f   %! OC1:MEASURE_143:SHIFTED_CLEF
%%% \once \override BassClarinetMusicStaff.Clef.extra-offset = #'(-2.5 . 0) %! OC1:MEASURE_143:SHIFTED_CLEF
