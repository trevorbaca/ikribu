...
def BCL(voice, measures):
    music = baca.make_tied_repeated_durations(measures(1, 6), [(1, 4)])
    voice.extend(music)
    music = baca.make_mmrests(measures(7, 12))
    voice.extend(music)
...
def VN(voice, measures):
    music = baca.make_repeated_duration_notes(measures(1, 9), [(1, 4)])
    voice.extend(music)
...
def VC(voice, measures):
    music = library.make_inscription_rhythm(measures(1, 11))
    voice.extend(music)
