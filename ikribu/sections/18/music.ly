              ...
              %! ikribu.make_empty_score()
            {
                ...
                <<
                    ...
                    \context Staff = "Bass_Clarinet.Music_Staff"
                      %! ikribu.make_empty_score()
                      %! baca.path.extern()
                    { \number.18.Bass_Clarinet.Music_Staff }
                    % ABSOLUTE_BEFORE:
                    % COMMANDS:
                    ...
                    <<
                        ...
                        \context RHStaff = "Violin_RH.Music_Staff"
                          %! ikribu.make_empty_score()
                          %! baca.path.extern()
                        { \number.18.Violin_RH.Music_Staff }
                        % ABSOLUTE_BEFORE:
                        % COMMANDS:
