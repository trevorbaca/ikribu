...
def bcl(m):
    ...
    with baca.scope(m.get(19, 21)) as o:
        baca.hairpins.exact(o[:2], "ppp<f")
        baca.hairpins.exact(o[-1:], "f>o!", rleak=True)
...
def vn(m):
    ...
    with baca.scope(m.get(1, 3)) as o:
        ...
        baca.hairpins.exact(o[:2], "ppp<p")
        baca.hairpins.exact(o[-1:], "p>o!", rleak=True)
...
def va(m):
    ...
    with baca.scope(m.get(19, 24)) as o:
        ...
        baca.hairpins.exact(o[:5], "ppp<mf")
        baca.hairpins.exact(o[-1:], "mf>o!", rleak=True)
