...
def BCL(voice, accumulator):
    ...
    voice.extend(music)
    music = baca.make_repeat_tied_notes_function(accumulator.get(19, 21))
    voice.extend(music)
...
def VN(voice, accumulator):
    ...
    voice.extend(music)
    music = baca.make_repeat_tied_notes_function(accumulator.get(7, 9))
    voice.extend(music)
    music = baca.make_mmrests(accumulator.get(10, 12), head=voice.name)
    voice.extend(music)
    music = baca.make_repeat_tied_notes_function(accumulator.get(13, 15))
    voice.extend(music)
...
def VA(voice, accumulator):
    ...
    voice.extend(music)
    music = baca.make_repeat_tied_notes_function(accumulator.get(19, 24))
    voice.extend(music)
