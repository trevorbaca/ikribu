...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.2.BassClarinet.MusicVoice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
    ...
    <<
          ...
          %! baca._make_multimeasure_rest_container(6)
        {
            ...
            % COMMANDS:
              ...
              %! baca._comment_measure_numbers()
            % [BassClarinet.RestVoice measure 6]
              %! MULTIMEASURE_REST
              %! REST_VOICE
...
number.2.BassClarinet.Staff = {
    ...
    \context Voice = "BassClarinet.MusicVoice"
      %! ikribu.make_empty_score()
      %! baca.path.extern()
    { \number.2.BassClarinet.MusicVoice }
    % CLOSING:
    % COMMANDS:
