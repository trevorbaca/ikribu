\context Score = "Score" \with {
    ...
    \context GlobalContext = "GlobalContext" <<
        ...
        \context GlobalSkips = "GlobalSkips" {
            ...
            \once \override TextScript.color = #(x11-color 'DarkCyan) % SEGMENT:REMINDER_METRONOME_MARK:2
            \newSpacingSection
            s1 * 1
            ^ \markup { % SEGMENT:REMINDER_METRONOME_MARK:3
                \fontsize % SEGMENT:REMINDER_METRONOME_MARK:3
                    #-6 % SEGMENT:REMINDER_METRONOME_MARK:3
                    \general-align % SEGMENT:REMINDER_METRONOME_MARK:3
                        #Y % SEGMENT:REMINDER_METRONOME_MARK:3
                        #DOWN % SEGMENT:REMINDER_METRONOME_MARK:3
                        \note-by-number % SEGMENT:REMINDER_METRONOME_MARK:3
                            #2 % SEGMENT:REMINDER_METRONOME_MARK:3
                            #0 % SEGMENT:REMINDER_METRONOME_MARK:3
                            #1 % SEGMENT:REMINDER_METRONOME_MARK:3
                \upright % SEGMENT:REMINDER_METRONOME_MARK:3
                    { % SEGMENT:REMINDER_METRONOME_MARK:3
                        = % SEGMENT:REMINDER_METRONOME_MARK:3
                        42 % SEGMENT:REMINDER_METRONOME_MARK:3
                    } % SEGMENT:REMINDER_METRONOME_MARK:3
                } % SEGMENT:REMINDER_METRONOME_MARK:3
