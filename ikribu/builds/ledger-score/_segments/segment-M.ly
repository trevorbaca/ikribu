            ...
            \context CelloStaffGroup = "CelloStaffGroup" <<
                ...
                \context CelloMusicStaff = "CelloMusicStaff" {
                    \context CelloMusicVoice = "CelloMusicVoice" {
                        ...
                        \once \override CelloMusicStaff.Clef.extra-offset = #'(-2.5 . 0)     %! +LEDGER_SCORE:OC %F%
                    ...
                    %F% \once \override CelloMusicStaff.Clef.X-extent = ##f          %! +SEGMENT:OC
                    %F% \once \override CelloMusicStaff.Clef.extra-offset = #'(-2.5 . 0)     %! +SEGMENT:OC
                        \once \override NoteHead.style = #'harmonic                  %! OC
                        \set CelloMusicStaff.forceClef = ##t                         %! EXPLICIT_CLEF:SM8
                        \clef "treble"                                               %! EXPLICIT_CLEF:SM8
                    %%% \once \override CelloMusicStaff.Clef.color = #(x11-color 'blue) %! EXPLICIT_CLEF_COLOR:SM6
