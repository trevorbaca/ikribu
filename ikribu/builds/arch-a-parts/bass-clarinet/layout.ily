    ...
    \context GlobalContext = "GlobalContext"
    {
        ...
        {   %*% PageLayout
            ...
            % [PageLayout measure 32]
              %! SPACING_COMMAND
            \baca-new-strict-spacing-section #2 #1
              %! BREAK
            \noBreak
            s1 * 7/4
              %! SPACING
            ...
            % [PageLayout measure 52]
              %! SPACING_COMMAND
            \baca-new-strict-spacing-section #1 #1
              %! BREAK
            \noBreak
            s1 * 3/4
              %! SPACING
            ...
            % [PageLayout measure 73]
              %! SPACING_COMMAND
            \baca-new-strict-spacing-section #35 #24
              %! BREAK
            \noBreak
            s1 * 7/4
              %! SPACING
            %@% \bacaStopTextSpanSPM
              %! SPACING
            %@% - \baca-start-spm-left-only "[[1/1 * 35/24]]"
              %! SPACING
            %@% \bacaStartTextSpanSPM
            ...
            % [PageLayout measure 84]
              %! SPACING_COMMAND
            \baca-new-strict-spacing-section #35 #48
              %! BREAK
            \noBreak
            s1 * 7/4
              %! SPACING
            ...
            % [PageLayout measure 162]
              %! SPACING_COMMAND
            \baca-new-strict-spacing-section #70 #24
              %! BREAK
            \noBreak
            s1 * 8/4
              %! SPACING
            %@% \bacaStopTextSpanSPM
              %! SPACING
            %@% - \baca-start-spm-left-only "[[2/1 * 35/24]]"
              %! SPACING
            %@% \bacaStartTextSpanSPM
