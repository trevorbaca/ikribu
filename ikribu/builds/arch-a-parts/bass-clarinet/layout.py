...
def main():
    ...
    layout = baca.make_layout(
        ...
        spacing=(1, 2),
        overrides=(
            baca.region((32, 33), (2, 1)),
            baca.region((36, 51), (1, 10)),
            baca.region([42, 46, 50], (1, 4)),
            baca.region((52, 61), (1, 1)),
            baca.region(64, (1, 1)),
            baca.region((71, 74), (1, 1)),
            baca.region([77, 78], (1, 1)),
            baca.region([85, 86], (1, 1)),
            baca.region([99, 100], (1, 1)),
            baca.region((116, 121), (1, 10)),
            baca.region(122, (2, 1)),
            baca.region([125, 127, 131, 135, 139], (1, 10)),
            baca.region([133, 137, 141, 149], (2, 1)),
            baca.region([158, 159, 162], (2, 1)),
            baca.region([167, 168], (2, 1)),
            baca.region([179, 187], (1, 12)),
            baca.region([241, 242], (1, 1)),
            baca.region((243, 244), (1, 10)),
            baca.region((247, 252), (1, 10)),
