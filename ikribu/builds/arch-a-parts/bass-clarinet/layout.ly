\context Score = "Score" <<
    \context GlobalContext = "GlobalContext" <<
        \context PageLayout = "PageLayout" {
            ...
            #'((Y-offset . 38) (alignment-distances . (0)))                              %! BREAK:IC
            \pageBreak                                                                   %! BREAK:IC
            s1 * 7/4
        ...
        %@%     }                                                                        %! SPACING_MARKUP:HSS2
            ...
            \noBreak                                                                     %! BREAK:BMM2
            \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details      %! BREAK:IC
            #'((Y-offset . 66) (alignment-distances . (0)))                              %! BREAK:IC
            \break                                                                       %! BREAK:IC
            s1 * 1
        %@% ^ \markup {                                                                  %! SPACING_MARKUP:HSS2
        %@%     \with-color                                                              %! SPACING_MARKUP:HSS2
        ...
        %@%     }                                                                        %! SPACING_MARKUP:HSS2
            ...
            \noBreak                                                                     %! BREAK:BMM2
            \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details      %! BREAK:IC
            #'((Y-offset . 94) (alignment-distances . (0)))                              %! BREAK:IC
            \break                                                                       %! BREAK:IC
            s1 * 1/2
        %@% ^ \markup {                                                                  %! SPACING_MARKUP:HSS2
        %@%     \with-color                                                              %! SPACING_MARKUP:HSS2
        ...
        %@%     }                                                                        %! SPACING_MARKUP:HSS2
            ...
            \noBreak                                                                     %! BREAK:BMM2
            \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details      %! BREAK:IC
            #'((Y-offset . 122) (alignment-distances . (0)))                             %! BREAK:IC
            \break                                                                       %! BREAK:IC
            s1 * 7/4
        %@% ^ \markup {                                                                  %! SPACING_MARKUP:HSS2
        %@%     \with-color                                                              %! SPACING_MARKUP:HSS2
        ...
        %@%     }                                                                        %! SPACING_MARKUP:HSS2
            ...
            \newSpacingSection                                                           %! SPACING:HSS1
            \set Score.proportionalNotationDuration = #(ly:make-moment 35 240)           %! SPACING:HSS1
            \noBreak                                                                     %! BREAK:BMM2
            s1 * 1
        %@% ^ \markup {                                                                  %! SPACING_MARKUP:HSS2
        %@%     \with-color                                                              %! SPACING_MARKUP:HSS2
        ...
        %@%     }                                                                        %! SPACING_MARKUP:HSS2
            ...
            \noBreak                                                                     %! BREAK:BMM2
            \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details      %! BREAK:IC
            #'((Y-offset . 150) (alignment-distances . (0)))                             %! BREAK:IC
            \break                                                                       %! BREAK:IC
            s1 * 3/4
        %@% ^ \markup {                                                                  %! SPACING_MARKUP:HSS2
        %@%     \with-color                                                              %! SPACING_MARKUP:HSS2
        ...
        %@%     }                                                                        %! SPACING_MARKUP:HSS2
            ...
            \noBreak                                                                     %! BREAK:BMM2
            \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details      %! BREAK:IC
            #'((Y-offset . 178) (alignment-distances . (0)))                             %! BREAK:IC
            \break                                                                       %! BREAK:IC
            s1 * 3/4
        %@% ^ \markup {                                                                  %! SPACING_MARKUP:HSS2
        %@%     \with-color                                                              %! SPACING_MARKUP:HSS2
        ...
        %@%     }                                                                        %! SPACING_MARKUP:HSS2
            ...
            \noBreak                                                                     %! BREAK:BMM2
            \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details      %! BREAK:IC
            #'((Y-offset . 10) (alignment-distances . (0)))                              %! BREAK:IC
            \pageBreak                                                                   %! BREAK:IC
            s1 * 1/2
        %@% ^ \markup {                                                                  %! SPACING_MARKUP:HSS2
        %@%     \with-color                                                              %! SPACING_MARKUP:HSS2
        ...
        %@%     }                                                                        %! SPACING_MARKUP:HSS2
            ...
            \newSpacingSection                                                           %! SPACING:HSS1
            \set Score.proportionalNotationDuration = #(ly:make-moment 35 24)            %! SPACING:HSS1
            \noBreak                                                                     %! BREAK:BMM2
            s1 * 7/4
        %@% ^ \markup {                                                                  %! SPACING_MARKUP:HSS2
        %@%     \with-color                                                              %! SPACING_MARKUP:HSS2
        ...
        %@%     }                                                                        %! SPACING_MARKUP:HSS2
            ...
            \newSpacingSection                                                           %! SPACING:HSS1
            \set Score.proportionalNotationDuration = #(ly:make-moment 35 48)            %! SPACING:HSS1
            \noBreak                                                                     %! BREAK:BMM2
            s1 * 7/4
        %@% ^ \markup {                                                                  %! SPACING_MARKUP:HSS2
        %@%     \with-color                                                              %! SPACING_MARKUP:HSS2
        ...
        %@%     }                                                                        %! SPACING_MARKUP:HSS2
            ...
            \newSpacingSection                                                           %! SPACING:HSS1
            \set Score.proportionalNotationDuration = #(ly:make-moment 35 12)            %! SPACING:HSS1
            \noBreak                                                                     %! BREAK:BMM2
            s1 * 2
        %@% ^ \markup {                                                                  %! SPACING_MARKUP:HSS2
        %@%     \with-color                                                              %! SPACING_MARKUP:HSS2
