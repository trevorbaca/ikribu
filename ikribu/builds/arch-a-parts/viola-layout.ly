\context Score = "Score" <<
    \context GlobalContext = "GlobalContext" <<
        \context PageLayout = "PageLayout" {
            ...
            #'((Y-offset . 75) (alignment-distances . (15 20)))                     %! +ARCH_A_PARTS:BREAKS:LMM3
            ...
            \noBreak %! +ARCH_A_PARTS:BREAKS:LMM2
            \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details %! +ARCH_A_PARTS:BREAKS:LMM3
            #'((Y-offset . 170) (alignment-distances . (15 20)))                    %! +ARCH_A_PARTS:BREAKS:LMM3
            ...
            \noBreak %! +ARCH_A_PARTS:BREAKS:LMM2
            \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details %! +ARCH_A_PARTS:BREAKS:LMM3
            #'((Y-offset . 20) (alignment-distances . (15 20)))                     %! +ARCH_A_PARTS:BREAKS:LMM3
            \pageBreak %! +ARCH_A_PARTS:BREAKS:LMM3
            s1 * 2
            ...
            \noBreak %! +ARCH_A_PARTS:BREAKS:LMM2
            \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details %! +ARCH_A_PARTS:BREAKS:LMM3
            #'((Y-offset . 130) (alignment-distances . (15 20)))                    %! +ARCH_A_PARTS:BREAKS:LMM3
            \break %! +ARCH_A_PARTS:BREAKS:LMM3
            s1 * 1
