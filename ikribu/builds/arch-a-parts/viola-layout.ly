\context Score = "Score" <<
    \context GlobalContext = "GlobalContext" <<
        \context PageLayout = "PageLayout" {
            ...
            \autoPageBreaksOff %! +ARCH_A_PARTS:BREAKS:BMM1
            \noBreak %! +ARCH_A_PARTS:BREAKS:BMM2
            \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details %! +ARCH_A_PARTS:BREAKS:BMM3
            #'((Y-offset . 75) (alignment-distances . (15 20)))                     %! +ARCH_A_PARTS:BREAKS:BMM3
            ...
            \pageBreak %! +ARCH_A_PARTS:BREAKS:BMM3
            ...
            \noBreak %! +ARCH_A_PARTS:BREAKS:BMM2
            \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details %! +ARCH_A_PARTS:BREAKS:BMM3
            #'((Y-offset . 170) (alignment-distances . (15 20)))                    %! +ARCH_A_PARTS:BREAKS:BMM3
            \break %! +ARCH_A_PARTS:BREAKS:BMM3
            s1 * 2
            ...
            \noBreak %! +ARCH_A_PARTS:BREAKS:BMM2
            \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details %! +ARCH_A_PARTS:BREAKS:BMM3
            #'((Y-offset . 20) (alignment-distances . (15 20)))                     %! +ARCH_A_PARTS:BREAKS:BMM3
            \pageBreak %! +ARCH_A_PARTS:BREAKS:BMM3
            s1 * 2
            ...
            \noBreak %! +ARCH_A_PARTS:BREAKS:BMM2
            \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details %! +ARCH_A_PARTS:BREAKS:BMM3
            #'((Y-offset . 130) (alignment-distances . (15 20)))                    %! +ARCH_A_PARTS:BREAKS:BMM3
            \break %! +ARCH_A_PARTS:BREAKS:BMM3
            s1 * 1
