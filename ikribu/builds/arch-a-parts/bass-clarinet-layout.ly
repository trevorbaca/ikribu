\context Score = "Score" <<
    \context GlobalContext = "GlobalContext" <<
        \context PageLayout = "PageLayout" {
            ...
            \autoPageBreaksOff                                                           %! +ARCH_A_PARTS_BCL:BREAKS:BMM1
            \noBreak                                                                     %! +ARCH_A_PARTS_BCL:BREAKS:BMM2
            \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details      %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
            #'((Y-offset . 38) (alignment-distances . (0)))                              %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
            ...
            \pageBreak                                                                   %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
        ...
        %@% \set Score.proportionalNotationDuration = #(ly:make-moment 1225 2304)        %! +SEGMENT:SPACING_OVERRIDE:SOC1
            ...
            \noBreak                                                                     %! +ARCH_A_PARTS_BCL:BREAKS:BMM2
            \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details      %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
            #'((Y-offset . 66) (alignment-distances . (0)))                              %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
            \break                                                                       %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
            s1 * 1
            %@% ^ \markup {                                                              %! SPACING_MARKUP:HSS2
            %@%     \with-color                                                          %! SPACING_MARKUP:HSS2
            %@%         #(x11-color 'ForestGreen)                                        %! SPACING_MARKUP:HSS2
        ...
        %@% \set Score.proportionalNotationDuration = #(ly:make-moment 1225 2304)        %! +SEGMENT:SPACING_OVERRIDE:SOC1
            ...
            \noBreak                                                                     %! +ARCH_A_PARTS_BCL:BREAKS:BMM2
            \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details      %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
            #'((Y-offset . 94) (alignment-distances . (0)))                              %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
            \break                                                                       %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
            s1 * 1/2
            %@% ^ \markup {                                                              %! SPACING_MARKUP:HSS2
            %@%     \with-color                                                          %! SPACING_MARKUP:HSS2
        ...
        %@% \set Score.proportionalNotationDuration = #(ly:make-moment 1225 2304)        %! +SEGMENT:SPACING_OVERRIDE:SOC1
            ...
            \noBreak                                                                     %! +ARCH_A_PARTS_BCL:BREAKS:BMM2
            \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details      %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
            #'((Y-offset . 122) (alignment-distances . (0)))                             %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
            \break                                                                       %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
            s1 * 7/4
            %@% ^ \markup {                                                              %! SPACING_MARKUP:HSS2
            %@%     \with-color                                                          %! SPACING_MARKUP:HSS2
        ...
        %@% \set Score.proportionalNotationDuration = #(ly:make-moment 1225 5760)        %! +SEGMENT:SPACING_OVERRIDE:SOC1
            ...
            \noBreak                                                                     %! +ARCH_A_PARTS_BCL:BREAKS:BMM2
            \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details      %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
            #'((Y-offset . 150) (alignment-distances . (0)))                             %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
            \break                                                                       %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
            s1 * 3/4
            %@% ^ \markup {                                                              %! SPACING_MARKUP:HSS2
            %@%     \with-color                                                          %! SPACING_MARKUP:HSS2
        ...
        %@% \set Score.proportionalNotationDuration = #(ly:make-moment 1225 5760)        %! +SEGMENT:SPACING_OVERRIDE:SOC1
            ...
            \noBreak                                                                     %! +ARCH_A_PARTS_BCL:BREAKS:BMM2
            \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details      %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
            #'((Y-offset . 178) (alignment-distances . (0)))                             %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
            \break                                                                       %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
            s1 * 3/4
            %@% ^ \markup {                                                              %! SPACING_MARKUP:HSS2
            %@%     \with-color                                                          %! SPACING_MARKUP:HSS2
        ...
        %@% \set Score.proportionalNotationDuration = #(ly:make-moment 1225 2304)        %! +SEGMENT:SPACING_OVERRIDE:SOC1
            ...
            \noBreak                                                                     %! +ARCH_A_PARTS_BCL:BREAKS:BMM2
            \overrideProperty Score.NonMusicalPaperColumn.line-break-system-details      %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
            #'((Y-offset . 10) (alignment-distances . (0)))                              %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
            \pageBreak                                                                   %! +ARCH_A_PARTS_BCL:BREAKS:BMM3
            s1 * 1/2
            %@% ^ \markup {                                                              %! SPACING_MARKUP:HSS2
            %@%     \with-color                                                          %! SPACING_MARKUP:HSS2
