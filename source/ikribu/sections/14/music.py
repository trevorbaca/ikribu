...
def BCL(voice, time_signatures):
    music = baca.make_mmrests(time_signatures(1), head=voice.get_name())
    voice.extend(music)
    ...
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(18, 19), head=voice.get_name())
    voice.extend(music)
    music = baca.make_repeat_tied_notes(time_signatures(20))
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(21, 22), head=voice.get_name())
    voice.extend(music)
